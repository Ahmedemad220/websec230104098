...
<form method="get">
    <div class="row mb-3">
        ...
        <div class="col col-sm-1">
            <a href="{{ url()->current() }}" class="btn btn-danger form-control">Reset</a>
        </div>
    </div>
</form>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12 col-lg-4">
                    <img src="{{ asset('images/' . ($product->photo ?? 'default.jpg')) }}" class="img-thumbnail" alt="{{ $product->name }}" width="100%">
                </div>
